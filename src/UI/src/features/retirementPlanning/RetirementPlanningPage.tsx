...
import { KeyboardNavigableTable } from '../../components/KeyboardNavigableTable';
            ...
            <>
              ...
              <section className="retirement-phase" aria-labelledby="contribution-years-title">
                ...
                <div className="retirement-table-wrap">
                  <KeyboardNavigableTable className="retirement-table retirement-table--contribution">
              ...
              <section className="retirement-phase" aria-labelledby="bridge-retirement-years-title">
                ...
                <div className="retirement-table-wrap">
                  <KeyboardNavigableTable className="retirement-table retirement-table--bridge">
              ...
              <section className="retirement-phase" aria-labelledby="standard-retirement-years-title">
                ...
                <div className="retirement-table-wrap">
                  <KeyboardNavigableTable className="retirement-table retirement-table--standard">
